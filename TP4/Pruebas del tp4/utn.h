...
/**
 * @fn int IngresarSoN(char*, char*, int)
 * @brief Funciona que toma una letra S o una letra N (si/no)
 *
 * @param letra ingresada
 * @param mensaje a mostrar por consola
 * @param numero de reintentos para el usuario
 * @return 1 en caso de que sea del que buffer sea S o N y 0 en caso de error
 */
int IngresarSoN (char* letra, char* mensaje, int reintentos);
